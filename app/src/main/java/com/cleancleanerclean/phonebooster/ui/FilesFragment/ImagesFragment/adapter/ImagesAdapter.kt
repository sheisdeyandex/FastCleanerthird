package com.cleancleanerclean.phonebooster.ui.FilesFragment.ImagesFragment.adapter
...
import com.cleancleanerclean.phonebooster.ui.FilesFragment.ImagesFragment.ImagesFragment
...
class ImagesAdapter(
    ...
    var fragmentImages: ImagesFragment = fragmentImages
    ...
    override fun onBindViewHolder(holder: ImagesAdapterViewHolder, position: Int) {
        ...
        holder.checktodelete.setOnCheckedChangeListener { _, isChecked ->
            ...
            if (isChecked) {
                ...
                fragmentImages.binding.ivShare.setOnClickListener {
                    share()
                }
                fragmentImages.binding.ivDelete.setOnClickListener {
